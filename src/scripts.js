...
board.createItem({ item: 'trap', top: TILE_SIZE *13, left: TILE_SIZE * 3});
...
board.createItem({ item: 'trap', top: TILE_SIZE * 16, left: TILE_SIZE * 16});
...
board.createEnemy({ top: TILE_SIZE * 8, left: TILE_SIZE * 15});
board.createEnemy({ top: TILE_SIZE * 10, left: TILE_SIZE * 5});
board.createEnemy({ top: TILE_SIZE * 12, left: TILE_SIZE * 8});
board.createEnemy({ top: TILE_SIZE * 14, left: TILE_SIZE * 10});
board.createEnemy({ top: TILE_SIZE * 2, left: TILE_SIZE * 3});
